...
// TODO: as correlations gets added in the data_source table as JSON, there's no way to delete an entry
...
func (s *Service) AddCorrelation(ctx context.Context, cmd *datasources.AddCorrelationCommand) error {
	return s.SQLStore.InTransaction(ctx, func(ctx context.Context) error {
